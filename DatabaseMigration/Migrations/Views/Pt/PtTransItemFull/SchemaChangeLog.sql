...
--changeset system:create-alter-view-PtTransItemFull context:any labels:c-any,o-view,ot-schema,on-PtTransItemFull,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view PtTransItemFull
CREATE OR ALTER VIEW dbo.PtTransItemFull AS
SELECT     dbo.PtTransItem.HdCreateDate, dbo.PtTransItem.HdCreator, dbo.PtTransItem.HdChangeDate, dbo.PtTransItem.HdChangeUser, 
                      ...
                      dbo.PtTransItem.MgLabAuszug, dbo.PtTransItem.CardNo, dbo.PtTransItem.SourceKey, dbo.PtTransItem.ClearingNo, 
                      dbo.PtTransItem.IsInactive, dbo.PtTransItem.DetailsOnStatement,
                      dbo.PtTransItem.AmountCvAcCu, dbo.PtTransItem.CvAmountTypeNo,dbo.PtTransItem.CvBookStatusNo,
                      dbo.PtTransItem.SourceCvBookStatusNo, dbo.PtTransItem.SourcePosIsCvRelevant,
	      dbo.PtTransItem.Id, dbo.PtTransItem.Id AS TransItemId, NULL AS TransItemDetailId
FROM         dbo.PtTransItem 
WHERE     dbo.PtTransItem.DetailCounter IN (0, 1)
AND dbo.PtTransItem.HdVersionNo between 1 AND 999999998

union all 
SELECT     dbo.PtTransItemDetail.TransItemCreationTime AS HdCreateDate, dbo.PtTransItemDetail.HdCreator, dbo.PtTransItemDetail.HdChangeDate, dbo.PtTransItemDetail.HdChangeUser, 
                      ...
                      dbo.PtTransItem.IsInactive, dbo.PtTransItem.DetailsOnStatement,
                      dbo.PtTransItemDetail.AmountCvAcCu, dbo.PtTransItemDetail.CvAmountTypeNo,dbo.PtTransItemDetail.CvBookStatusNo,
                      dbo.PtTransItemDetail.SourceCvBookStatusNo, dbo.PtTransItemDetail.SourcePosIsCvRelevant,
                      dbo.PtTransItemDetail.Id, dbo.PtTransItem.Id AS TransItemId, dbo.PtTransItemDetail.Id AS TransItemDetailId 
FROM         dbo.PtTransItem  INNER JOIN 
