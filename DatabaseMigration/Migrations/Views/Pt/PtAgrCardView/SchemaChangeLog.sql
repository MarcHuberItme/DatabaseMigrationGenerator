...
--changeset system:create-alter-view-PtAgrCardView context:any labels:c-any,o-view,ot-schema,on-PtAgrCardView,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view PtAgrCardView
CREATE OR ALTER VIEW dbo.PtAgrCardView AS
SELECT  C.Id, 
                C.HdCreateDate, 
                C.HdCreator, 
                C.HdChangeDate, 
