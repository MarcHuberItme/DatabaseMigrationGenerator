...
--changeset system:create-alter-view-PtAgrCardView01 context:any labels:c-any,o-view,ot-schema,on-PtAgrCardView01,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view PtAgrCardView01
CREATE OR ALTER VIEW dbo.PtAgrCardView01 AS
SELECT  C.Id, 
                C.HdCreateDate, 
                C.HdCreator, 
                C.HdChangeDate, 
	...
	PC.ReturnDate As ReturnDatePrevious,
                ...
                C.AgentId,
	C.ECommerceActive,
	C.PurchaseWithCashBack,
	C.MerchantInitiatedTrx,
	C.RestrictATM,
	C.RestrictPOS,
	C.OtrcOrderType
FROM PtAgrCard As C
...
INNER JOIN PtBase As PTB ON P.PartnerId = PTB.Id
