...
--changeset system:create-alter-view-PtTransDataForPrintingWOStView context:any labels:c-any,o-view,ot-schema,on-PtTransDataForPrintingWOStView,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view PtTransDataForPrintingWOStView
CREATE OR ALTER VIEW dbo.PtTransDataForPrintingWOStView AS
SELECT
TM.TransactionId,
