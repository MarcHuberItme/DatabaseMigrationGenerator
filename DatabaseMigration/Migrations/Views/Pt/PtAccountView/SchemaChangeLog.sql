...
--changeset system:create-alter-view-PtAccountView context:any labels:c-any,o-view,ot-schema,on-PtAccountView,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view PtAccountView
CREATE OR ALTER VIEW dbo.PtAccountView AS
