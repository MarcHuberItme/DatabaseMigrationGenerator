...
--changeset system:create-alter-view-PtTransMessageFuturesPosVwOpen context:any labels:c-any,o-view,ot-schema,on-PtTransMessageFuturesPosVwOpen,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view PtTransMessageFuturesPosVwOpen
CREATE OR ALTER VIEW dbo.PtTransMessageFuturesPosVwOpen AS
select 
     Pos.Id, 
     Pos.HdCreateDate,
     Pos.HdCreator,
...
and F.FuturesStatusNo = 1 and F.HdVersionNo between 1 and 999999998)
