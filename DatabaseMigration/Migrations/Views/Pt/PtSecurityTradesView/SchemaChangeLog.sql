...
--changeset system:create-alter-view-PtSecurityTradesView context:any labels:c-any,o-view,ot-schema,on-PtSecurityTradesView,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view PtSecurityTradesView
CREATE OR ALTER VIEW dbo.PtSecurityTradesView AS
...
SELECT TOP 100 PERCENT Case When PO.PooledTransNo Is Null Then tro.OrderNo Else PO.OrderNo End As OrderNo
	...
	, Case When tom.IsStockExOrder=0 And tro.IsListingOrder=1 Then Null Else trt.PortfolioId End As BrokerPortfolioId , trt.StockExRef AS TradeId, trt.MarketValueHoCu
