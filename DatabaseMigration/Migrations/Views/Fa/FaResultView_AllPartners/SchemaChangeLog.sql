...
--changeset system:create-alter-view-FaResultView_AllPartners context:any labels:c-any,o-view,ot-schema,on-FaResultView_AllPartners,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view FaResultView_AllPartners
CREATE OR ALTER VIEW dbo.FaResultView_AllPartners AS
SELECT 
       v.PartnerNo, 
       v.PtDescription,
       MaxTotalBalanceUSD,
