...
--changeset system:create-alter-view-AsCorrPartnerView context:any labels:c-any,o-view,ot-schema,on-AsCorrPartnerView,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view AsCorrPartnerView
CREATE OR ALTER VIEW dbo.AsCorrPartnerView AS
 --CarrierType
SELECT 
...
WHERE AsCorrItemGroup.IsForPartnerCorr = '1'
