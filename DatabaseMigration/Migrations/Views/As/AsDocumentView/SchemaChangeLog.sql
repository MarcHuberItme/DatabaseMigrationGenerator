...
--changeset system:create-alter-view-AsDocumentView context:any labels:c-any,o-view,ot-schema,on-AsDocumentView,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view AsDocumentView
CREATE OR ALTER VIEW dbo.AsDocumentView AS
SELECT	TOP 100 PERCENT 
	...
	Do.Amount, Do.Location, Do.HdVersionNo as DocVersionNo, 
                Ci.IsPrivacyRelevant, Ci.FunctionGroupNo, Do.PrivacyGroupNo
