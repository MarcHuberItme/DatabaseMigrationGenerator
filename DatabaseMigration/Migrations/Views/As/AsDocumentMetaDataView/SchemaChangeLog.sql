...
--changeset system:create-alter-view-AsDocumentMetaDataView context:any labels:c-any,o-view,ot-schema,on-AsDocumentMetaDataView,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view AsDocumentMetaDataView
CREATE OR ALTER VIEW dbo.AsDocumentMetaDataView AS
...
LEFT OUTER JOIN AsDocumentDataAccessLog log2 on log2.AsDocumentDataId = log1.AsDocumentDataId AND log1.AccessLogSequence < log2.AccessLogSequence
