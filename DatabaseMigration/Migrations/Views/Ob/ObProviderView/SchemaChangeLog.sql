...
--changeset system:create-alter-view-ObProviderView context:any labels:c-any,o-view,ot-schema,on-ObProviderView,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create view ObProviderView
CREATE OR ALTER VIEW dbo.ObProviderView AS
select 
	ObHub.Id as HubId,
