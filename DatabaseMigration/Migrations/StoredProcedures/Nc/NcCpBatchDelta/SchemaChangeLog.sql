...
--changeset system:create-alter-procedure-NcCpBatchDelta context:any labels:c-any,o-stored-procedure,ot-schema,on-NcCpBatchDelta,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure NcCpBatchDelta
CREATE OR ALTER PROCEDURE dbo.NcCpBatchDelta
...
BEGIN
	...
	INNER JOIN PtBase pb ON pb.Id = cp.PartnerId
		...
		AND cp.HdChangeDate > @LastExecutionDate
