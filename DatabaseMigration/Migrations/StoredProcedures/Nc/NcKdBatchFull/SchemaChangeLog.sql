...
--changeset system:create-alter-procedure-NcKdBatchFull context:any labels:c-any,o-stored-procedure,ot-schema,on-NcKdBatchFull,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure NcKdBatchFull
CREATE OR ALTER PROCEDURE dbo.NcKdBatchFull
@LastPartnerNo int, 
