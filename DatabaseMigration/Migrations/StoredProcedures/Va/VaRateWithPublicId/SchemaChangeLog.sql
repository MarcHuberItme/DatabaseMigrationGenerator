...
--changeset system:create-alter-procedure-VaRateWithPublicId context:any labels:c-any,o-stored-procedure,ot-schema,on-VaRateWithPublicId,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure VaRateWithPublicId
CREATE OR ALTER PROCEDURE dbo.VaRateWithPublicId
--Store Procedure: VaRateWithPublicId:
...
/*
	...
	Declare @Publicid AS uniqueidentifier
	...
	Set @PublicId ='28F5CD33-CDC2-4BCC-9E6F-B99C6811570D'--'{D607ECF0-9D2C-4FE7-9090-1F160745A0A9}'
	Set @DateDiff = -3	
*/
