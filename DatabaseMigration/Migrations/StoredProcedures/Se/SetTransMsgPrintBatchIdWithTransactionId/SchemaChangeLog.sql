...
--changeset system:create-alter-procedure-SetTransMsgPrintBatchIdWithTransactionId context:any labels:c-any,o-stored-procedure,ot-schema,on-SetTransMsgPrintBatchIdWithTransactionId,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure SetTransMsgPrintBatchIdWithTransactionId
CREATE OR ALTER PROCEDURE dbo.SetTransMsgPrintBatchIdWithTransactionId
