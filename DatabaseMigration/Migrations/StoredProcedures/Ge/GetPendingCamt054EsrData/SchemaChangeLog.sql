...
--changeset system:create-alter-procedure-GetPendingCamt054EsrData context:any labels:c-any,o-stored-procedure,ot-schema,on-GetPendingCamt054EsrData,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetPendingCamt054EsrData
CREATE OR ALTER PROCEDURE dbo.GetPendingCamt054EsrData
