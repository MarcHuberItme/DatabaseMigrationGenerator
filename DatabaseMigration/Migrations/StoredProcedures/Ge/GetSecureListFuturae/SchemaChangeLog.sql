...
--changeset system:create-alter-procedure-GetSecureListFuturae context:any labels:c-any,o-stored-procedure,ot-schema,on-GetSecureListFuturae,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetSecureListFuturae
CREATE OR ALTER PROCEDURE dbo.GetSecureListFuturae
...
FROM
(
SELECT PtAgrSecureList.SeqNo, PtAgrSecureList.VersionNo,PtAgrSecureList.PrevEbankingNo, PtAgrSecureList.FuturaeCodePrinted,
       PtAgrSecureList.FuturaeDeviceActivationCode, PtAgrSecureList.FuturaeActivationCodeValidity, PtAgrSecureList.AstActivationImage,
              PtBase.PartnerNo, 
