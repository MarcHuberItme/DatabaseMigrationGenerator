...
--changeset system:create-alter-procedure-GetAcComp1CurVal context:any labels:c-any,o-stored-procedure,ot-schema,on-GetAcComp1CurVal,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetAcComp1CurVal
CREATE OR ALTER PROCEDURE dbo.GetAcComp1CurVal
