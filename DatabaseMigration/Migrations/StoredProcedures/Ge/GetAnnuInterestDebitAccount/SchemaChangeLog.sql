...
--changeset system:create-alter-procedure-GetAnnuInterestDebitAccount context:any labels:c-any,o-stored-procedure,ot-schema,on-GetAnnuInterestDebitAccount,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetAnnuInterestDebitAccount
CREATE OR ALTER PROCEDURE dbo.GetAnnuInterestDebitAccount
