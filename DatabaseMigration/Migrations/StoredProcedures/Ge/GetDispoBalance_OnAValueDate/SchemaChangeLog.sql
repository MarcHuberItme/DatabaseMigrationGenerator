...
--changeset system:create-alter-procedure-GetDispoBalance_OnAValueDate context:any labels:c-any,o-stored-procedure,ot-schema,on-GetDispoBalance_OnAValueDate,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetDispoBalance_OnAValueDate
CREATE OR ALTER PROCEDURE dbo.GetDispoBalance_OnAValueDate
...
FROM  
   PtTransitem
WHERE  
  PtTransItem.ValueDate >= DATEADD(Day,1,@ValueDate)
