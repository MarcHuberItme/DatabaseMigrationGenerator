...
--changeset system:create-alter-procedure-GetBalance_OnAValueDate context:any labels:c-any,o-stored-procedure,ot-schema,on-GetBalance_OnAValueDate,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetBalance_OnAValueDate
CREATE OR ALTER PROCEDURE dbo.GetBalance_OnAValueDate
