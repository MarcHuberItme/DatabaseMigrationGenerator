...
--changeset system:create-alter-procedure-GetTransItemsOfTransaction context:any labels:c-any,o-stored-procedure,ot-schema,on-GetTransItemsOfTransaction,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetTransItemsOfTransaction
CREATE OR ALTER PROCEDURE dbo.GetTransItemsOfTransaction
(@TransId  as uniqueidentifier,
@LanguageNo as int)
...
Where PtTransItem.TransId = @TransId  
...
Where PtTransItemDetail.TransactionId = @TransId 
)
