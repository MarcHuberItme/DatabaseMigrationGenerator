...
--changeset system:create-alter-procedure-GetAnnuPaybackDebitAccount context:any labels:c-any,o-stored-procedure,ot-schema,on-GetAnnuPaybackDebitAccount,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetAnnuPaybackDebitAccount
CREATE OR ALTER PROCEDURE dbo.GetAnnuPaybackDebitAccount
