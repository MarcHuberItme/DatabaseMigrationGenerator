...
--changeset system:create-alter-procedure-GetBalance_AvailableExtended_WithLatestTransTime context:any labels:c-any,o-stored-procedure,ot-schema,on-GetBalance_AvailableExtended_WithLatestTransTime,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetBalance_AvailableExtended_WithLatestTransTime
CREATE OR ALTER PROCEDURE dbo.GetBalance_AvailableExtended_WithLatestTransTime
...
Select 
	...
	@PrReferenceId=PrReference.Id,
                @LatestTransactionDateTime = PtPosition.LatestTransDateTime
from 
