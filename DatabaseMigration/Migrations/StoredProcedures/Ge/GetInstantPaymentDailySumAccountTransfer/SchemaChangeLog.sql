...
--changeset system:create-alter-procedure-GetInstantPaymentDailySumAccountTransfer context:any labels:c-any,o-stored-procedure,ot-schema,on-GetInstantPaymentDailySumAccountTransfer,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetInstantPaymentDailySumAccountTransfer
CREATE OR ALTER PROCEDURE dbo.GetInstantPaymentDailySumAccountTransfer
...
AND PtPaymentOrderDetail.SlipType = 6 AND PtPaymentOrderDetail.AccountNo IS NOT NULL -- this row is for AccountTransfer
