...
--changeset system:create-alter-procedure-GetForeignCyItemsByCurrencyCoba context:any labels:c-any,o-stored-procedure,ot-schema,on-GetForeignCyItemsByCurrencyCoba,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create stored procedure GetForeignCyItemsByCurrencyCoba
CREATE OR ALTER PROCEDURE dbo.GetForeignCyItemsByCurrencyCoba
@Currency AS CHAR(3),
