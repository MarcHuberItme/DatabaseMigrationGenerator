...
--changeset system:create-alter-function-GetStringValue context:any labels:c-any,o-function,ot-schema,on-GetStringValue,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create function GetStringValue
CREATE OR ALTER FUNCTION dbo.GetStringValue
(@INPUT VARCHAR(8000), @VaribleName Varchar(1000)) Returns Varchar(512)
