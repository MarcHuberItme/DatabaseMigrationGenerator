...
--changeset system:create-alter-function-getBooleanValue context:any labels:c-any,o-function,ot-schema,on-getBooleanValue,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create function getBooleanValue
CREATE OR ALTER FUNCTION dbo.getBooleanValue
(@INPUT VARCHAR(8000), @VaribleName Varchar(1000)) Returns Bit
...
Return CAST ( isnull(@OUTPUT,0) AS Bit )
