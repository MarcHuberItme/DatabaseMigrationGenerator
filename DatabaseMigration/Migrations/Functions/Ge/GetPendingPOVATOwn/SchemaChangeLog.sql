...
--changeset system:create-alter-function-GetPendingPOVATOwn context:any labels:c-any,o-function,ot-schema,on-GetPendingPOVATOwn,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create function GetPendingPOVATOwn
CREATE OR ALTER FUNCTION dbo.GetPendingPOVATOwn
(
@TransDate datetime,
@iLanguageNo int
)
