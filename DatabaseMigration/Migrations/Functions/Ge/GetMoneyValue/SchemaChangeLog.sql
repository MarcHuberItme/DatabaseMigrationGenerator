...
--changeset system:create-alter-function-GetMoneyValue context:any labels:c-any,o-function,ot-schema,on-GetMoneyValue,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create function GetMoneyValue
CREATE OR ALTER FUNCTION dbo.GetMoneyValue
(@INPUT VARCHAR(8000), @VaribleName Varchar(1000)) Returns Money
...
Return CAST ( isnull(@OUTPUT,0) AS Money )
