...
--changeset system:create-alter-function-GetDecimalValue context:any labels:c-any,o-function,ot-schema,on-GetDecimalValue,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create function GetDecimalValue
CREATE OR ALTER FUNCTION dbo.GetDecimalValue
(@INPUT VARCHAR(8000), @VaribleName Varchar(1000)) Returns Decimal
...
Return CAST ( isnull(@OUTPUT,0) AS Decimal )
