...
--changeset system:create-alter-function-GetCountryListByGroupLabel context:any labels:c-any,o-function,ot-schema,on-GetCountryListByGroupLabel,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create function GetCountryListByGroupLabel
CREATE OR ALTER FUNCTION dbo.GetCountryListByGroupLabel
(
