...
--changeset system:create-alter-function-GetTextNoListByGroupLbl context:any labels:c-any,o-function,ot-schema,on-GetTextNoListByGroupLbl,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create function GetTextNoListByGroupLbl
CREATE OR ALTER FUNCTION dbo.GetTextNoListByGroupLbl
(
...
INSERT INTO @Table
SELECT TextNo FROM PtTransItemText AS C 
