...
--changeset system:create-alter-function-PosQuantityTradeDate context:any labels:c-any,o-function,ot-schema,on-PosQuantityTradeDate,fin-13659 runOnChange:true splitStatements:false stripComments:false endDelimiter:GO
--comment: Create function PosQuantityTradeDate
CREATE OR ALTER FUNCTION dbo.PosQuantityTradeDate
(
